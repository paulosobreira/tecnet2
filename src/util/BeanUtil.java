...
public class BeanUtil {
        ...
        for (Iterator iter = mapOrigem.keySet().iterator(); iter.hasNext();) {
            ...
            if (mapDestino.keySet().contains(propriedade)) {
                Class propriedadeTipo =
                    PropertyUtils.getPropertyType(destino, propriedade);
    ...
    public static void copiarVOTipoString(Object origem, Object destino)
        ...
        for (Iterator iter = mapOrigem.keySet().iterator(); iter.hasNext();) {
            ...
            if (mapDestino.keySet().contains(propriedade)) {
                Class propriedadeTipo =
                    PropertyUtils.getPropertyType(origem, propriedade);
                ovalor = PropertyUtils.getProperty(origem, propriedade);
    ...
    private static void setarPropriedadeStringTipo(Object beanVo,
        ...
        try {
            ...
            if (datatype.equals("java.lang.String") ||
                ...
                java.sql.Date ovalor =
                    FormatDate.parseDate(valor, Constantes.DATA_FORMATO);
                BeanUtils.setProperty(beanVo, propriedade, ovalor);
    ...
    /**
     * Verifica se um VO est no estado em q foi criado, isto ,
     * com todas as propriedades vazias.
     * @param vo
     * @return
     * @throws Exception
     */
    public static boolean voVazio(Object vo) throws Exception {
        ...
        for (Iterator iter = mapAmostra.keySet().iterator(); iter.hasNext();) {
            ...
            if (mapCopiavazia.keySet().contains(propriedade)) {
                valorAmostra =
                    PropertyUtils.getProperty(mapAmostra, propriedade);
                valorCopia =
                    PropertyUtils.getProperty(mapCopiavazia, propriedade);
    ...
    /**
     * Retorna o nome das propridades do Vo em formato de lista
     * Para ser usado com propriedaeds escluidas ou exibiveis do preecherVO
     * obs.: A propriedade Class  excluida
     * @param object - Vo a ser introspectado
     * @return uma lista com nome das propriedaeds ex.:
     * [entr_documento, entr_valor_frete, entr_outras_despesas]
     * @throws NoSuchMethodException
     * @throws InvocationTargetException
     * @throws IllegalAccessException
     */
    ...
    public static void removerPropriedadesExcluidas(Map propriedades,
        ...
        /**
         * Excluindo todas as propriedades que so null
            ...
            if ((propriedadeNome != null) &&
                ...
                if (propriedadesExcluidas != null) {
                    for (int i = 0; i < propriedadesExcluidas.length; i++) {
                        if (propriedadeNome.equalsIgnoreCase(
                                    propriedadesExcluidas[i])) {
                            remover.add(propriedadeNome);
                        }
                    }
                }
    ...
    public static void copiarCollections(List list, List listaCopia)
        throws IllegalAccessException, 
            InvocationTargetException, 
