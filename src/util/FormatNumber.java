...
/**
 * Class: FormatNumber <p>
 *
 * This class is responsable for all number format and conversions.
 *
 * @author Anderson Teixeira & Ronaldo Costa <anderson@lojasmaia.com.br, ronaldo@lojasmaia.com.br>
  ...
  */
  ...
  public static String fillMode(String valor, String fill) {
    if (valor.length() < fill.length()) {
      return fill.substring(0, fill.length() - valor.length()) + valor.trim();
    }
    return valor;
  }
