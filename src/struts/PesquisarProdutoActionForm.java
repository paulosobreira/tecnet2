...
public class PesquisarProdutoActionForm extends ActionForm implements java.io.Serializable {
    private long id;
    ...
    public PesquisarProdutoActionForm() {
    }

    public PesquisarProdutoActionForm(long id, java.lang.String nome,
        java.lang.String descricao, java.lang.String cor, double peso,
        double preco) {
        this.id = id;
        this.nome = nome;
